# -*- encoding: utf-8 -*-
# stub: devise-two-factor 2.0.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<devise>, ["~> 3.5.0"])
      ...
      s.add_dependency(%q<attr_encrypted>, ["~> 1.3.2"])
      s.add_dependency(%q<devise>, ["~> 3.5.0"])
      s.add_dependency(%q<rotp>, ["~> 2"])
